...
import { generateMonths } from '../constants/index.js'
...
export default function Layout({ children }) {
  ...
  return (
    <div className="app">
      ...
      <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <div className="sb-foot">
          <div className="sb-user">
            ...
            <button className="s-out" onClick={() => setShowLogoutModal(true)} title="Sign out"><LogoutIcon /></button>
          </div>
        </div>
      </aside>
      ...
      {showLogoutModal && (
        <ConfirmModal
          message="Sign out of GharKharcha?"
    ...
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal">
        ...
        <div className="fg">
          ...
          <input className="fi" value={name} onChange={e => setName(e.target.value)} placeholder="e.g. family Home Expenses" />
        </div>
        <div className="fg">
          <label className="fl">Description (optional)</label>
          <input className="fi" value={desc} onChange={e => setDesc(e.target.value)} placeholder="e.g. All home expenses for 2026" />
        </div>
        <div className="fg">
